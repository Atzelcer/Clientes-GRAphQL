...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'personas' => App\GraphQL\Queries\PersonasQuery::class,
                'login' => App\GraphQL\Queries\LoginQuery::class,
            ],
            'mutation' => [
                'createPersona' => App\GraphQL\Mutations\CreatePersonaMutation::class,
                'updatePersona' => App\GraphQL\Mutations\UpdatePersonaMutation::class,
                'deletePersona' => App\GraphQL\Mutations\DeletePersonaMutation::class,
            ],
            'types' => [
                App\GraphQL\Types\PersonaType::class,
            ],
